...
class EmpresaController extends Controller {
    ...
    public function index()
    {
        ...
        if (count ($empresas ) > 0) {
            ...
            $imagens = Imagens::where('conteudo_tipo', 'L')->get();
    ...
    public function create()
    {
        ...
        return view('painel.empresa.create-edit', compact('title','estados'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('painel.empresa.create-edit',compact('empresa', 'title','estados','nm_imagem'));
    }
    ...
    public function update(EmpresaFormRequest $request, $id)
    {
        ...
        foreach ($request->photos as $photo) {
            ...
            $imagens = DB::table('imagens')
                        ...
                        ->update(array('nm_imagem' => $nm_imagem));
        }
