...
class CreateFornecedoresTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('fornecedores', function (Blueprint $table) {
            ...
            $table->string('endereco',80)->nulllable();
            $table->string('numero',10)->nulllable();
            $table->string('complemento',20)->nulllable();
            $table->string('bairro',80)->nulllable();
            $table->string('cidade',45)->nulllable();
            $table->string('uf',2)->nulllable();
            $table->string('pais',45)->nulllable();
